...
import prop2d_cython_4_loop_par
...
prop2d_cython_4_loop_par.exact_prop_2D_cython(in_wave,out_wave,L_in,L_in,0,0,wavel,z)
...
get_ipython().run_line_magic('timeit', 'prop2d_cython_4_loop_par.exact_prop_2D_cython(in_wave,out_wave,L_in,L_in,0,0,wavel,z)')
